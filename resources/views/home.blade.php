        ...
        <div class="row align-items-center">
            <div class="col-lg-6 hero-content" data-aos="fade-right">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="{{ route('projects.index') }}" class="btn btn-warning btn-lg">
            ...
            <div class="col-lg-6 text-center" data-aos="fade-left">
                <div class="hero-image">
                    <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=500" 
                         alt="Developer" class="img-fluid rounded-circle" style="width: 300px; height: 300px; object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="mb-4">
                    ...
                    I specialize in Laravel, Vue.js, and modern web technologies.
                </p>
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-6">
                        <div class="text-center">
                            <h3 class="h2 text-primary mb-1">3+</h3>
